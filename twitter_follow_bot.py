...
# list in
ALREADY_FOLLOWED_FILE = "/home/tshelley/Dev/already-followed.csv"
...
def auto_follow_followers_for_user(user_screen_name, count=20):
    """
...
def auto_unfollow_nonfollowers():
    ...
    for user_id in not_following_back:
        if user_id not in users_keep_following and count > 20:
